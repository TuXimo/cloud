...
if ($PSVersionTable.PSVersion.Major -gt $PSMinVersion) {
  ...
  Invoke-WebRequest -Uri "https://raw.githubusercontent.com/TuXimo/cloud/main/color.ini" -UseBasicParsing -OutFile "$sp_dot_dir\Hazy\color.ini"
  Invoke-WebRequest -Uri "https://raw.githubusercontent.com/TuXimo/cloud/main/user.css" -UseBasicParsing -OutFile "$sp_dot_dir\Hazy\user.css"
  Invoke-WebRequest -Uri "https://raw.githubusercontent.com/TuXimo/cloud/main/theme.js" -UseBasicParsing -OutFile "$sp_dot_dir\Hazy\theme.js"
  Write-Done
